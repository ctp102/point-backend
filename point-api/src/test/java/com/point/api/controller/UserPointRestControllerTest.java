...
public class UserPointRestControllerTest {
    ...
    void earnPointTest() throws Exception {
        ...
        userRepository.findById(1L).ifPresent(user -> {
            Assertions.assertThat(user.getRemainPoint()).isEqualTo(15_000L); // 가입 시 10_000 포인트 적립
        });
    }
    ...
    void deductPointTest() throws Exception {
        ...
        userRepository.findById(1L).ifPresent(user -> {
            Assertions.assertThat(user.getRemainPoint()).isEqualTo(10_000L);
        });
    }
    ...
    void cancelDeductPointTest() throws Exception {
        ...
        userRepository.findById(1L).ifPresent(user -> {
            Assertions.assertThat(user.getRemainPoint()).isEqualTo(15_000L);
        });
    }
