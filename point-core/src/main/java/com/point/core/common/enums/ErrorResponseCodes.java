...
public enum ErrorResponseCodes implements CustomResponseCodes {
    ...
    EARN_POINT_MUST_BE_POSITIVE             (400, "적립 포인트는 0보다 커야 합니다."),
    DEDUCT_POINT_MUST_BE_POSITIVE           (400, "차감 포인트는 0보다 커야 합니다."),
    DEDUCT_CANCEL_POINT_MUST_BE_POSITIVE    (400, "차감 취소 포인트는 0보다 커야 합니다."),
